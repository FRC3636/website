...
const Index: React.FC<Props> = (_props) => (
	<Layout>
		<>
			<SimpleSection className="hidden md:flex bg-black dark:bg-white text-white dark:text-black">
				<span className="self-center transform -rotate-90 text-11xl font-serif extrabold">
					3636
				</span>
			</SimpleSection>
			<SimpleSection className="bg-white dark:bg-black text-black dark:text-white">
				<h1 className="text-5xl my-2">Grant Robotics</h1>
